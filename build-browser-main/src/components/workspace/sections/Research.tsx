...
import { Github, Layers, FileText, FlaskConical } from "lucide-react";
...
export function ResearchIndex({ research, onOpen }: { research: ResearchDef[]; onOpen: (t: TabKind) => void }) {
  return (
    <div className="mx-auto max-w-5xl px-8 py-10">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {research.map((r, i) => {
          const Icon = SEED_ICON_BY_ID[r.id] ?? FlaskConical;
          return (
            <motion.button
              key={r.id}
